...
The portal should not behave like a marketing page or a generic dashboard. It should behave like a calm media-buying desk: overview, creators, niches, platform stats, creator media, checkout, order, approve, report.
...
- Existing VANTA UI primitives can carry the surface without a new design system.
- Current marketplace objects map cleanly to buyable packages, campaign orders, approvals, packages, and submissions.
- Qualified Attention should sit as a proof layer beside objective-specific outcomes.

## What Is Still Unknown

- Exact advertiser auth provider and invite lifecycle.
- Final pricing rules and approval thresholds.
- Which review assets need native upload versus external URLs.
- Real-time freshness requirements for inventory availability.

## Next Experiments

- Replace local data with advertiser creator, niche, stats, checkout, order, and campaign endpoints.
- Add schema-driven brief validation with field-level errors.
- Implement advertiser review mutations against submissions.
- Validate the inventory discovery flow with actual sales inventory.
