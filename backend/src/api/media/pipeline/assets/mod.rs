...
pub(crate) use asset_records::{
    ...
    fetch_media_asset_by_upload_id_for_database, fetch_media_asset_by_upload_job,
    fetch_media_asset_by_upload_job_for_database, fetch_media_assets,
    fetch_media_assets_for_database,
};
