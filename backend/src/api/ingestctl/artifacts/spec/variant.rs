...
pub(in crate::api::ingestctl::artifacts) struct LiveRuntimeVariantSpec {
    pub(in crate::api::ingestctl::artifacts) label: String,
    pub(in crate::api::ingestctl::artifacts) width: i64,
    pub(in crate::api::ingestctl::artifacts) height: i64,
    pub(in crate::api::ingestctl::artifacts) video_bitrate_bps: i64,
    pub(in crate::api::ingestctl::artifacts) bandwidth_bps: i64,
    pub(in crate::api::ingestctl::artifacts) output_relative_dir: String,
    pub(in crate::api::ingestctl::artifacts) relative_playlist_path: String,
    pub(in crate::api::ingestctl::artifacts) segment_relative_pattern: String,
}

pub(in crate::api::ingestctl::artifacts) fn build_live_runtime_variant_specs(
