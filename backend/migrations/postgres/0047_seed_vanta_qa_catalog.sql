...
('film-ghost-standard', 'ghost-standard', 'Ghost Standard', 'A protocol no one remembers keeps passing audit.', 'When an old broadcast standard begins authenticating impossible footage, a compliance engineer tracks the source through a maze of archives, live rooms, and forgotten hardware.', 2026, 'PG-13', '["Science Fiction","Cinematic Tech"]', '{"poster":"https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=900&q=80","backdrop":"https://images.unsplash.com/photo-1517976487492-5750f3195933?auto=format&fit=crop&w=1600&q=80","thumbnail":"https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=900&q=80","logo":null}', '[{"id":"cr-ghost-1","name":"Rin Vale","role":"Writer","character":null},{"id":"cr-ghost-2","name":"Aria Labs","role":"Studio","character":null}]', 96, 1, 1, '#c7f5ff', 6420),
